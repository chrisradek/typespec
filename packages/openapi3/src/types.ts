...
export interface OpenAPI3UnversionedServiceRecord {
  ...
  readonly document: OpenAPI3Document | OpenAPIDocument3_1;
...
export type JsonSchema<ExtraFields = {}> = ExtraFields & {
  /**
   * The JSON type for the schema.
   ...
   */
  allOf?: Refable<JsonSchema<ExtraFields>>[];
   ...
   */
  anyOf?: Refable<JsonSchema<ExtraFields>>[];
   ...
   */
  oneOf?: Refable<JsonSchema<ExtraFields>>[];

  /**
   *  An instance is valid against this keyword if it fails to validate successfully against the schema defined by this keyword.
   * @see https://json-schema.org/draft/2020-12/json-schema-core#name-not
   */
  not?: Refable<JsonSchema<ExtraFields>>;
   ...
   */
  prefixItems?: Refable<JsonSchema<ExtraFields>>[];
   ...
   * */
  items?: Refable<JsonSchema<ExtraFields>>;
   ...
   */
  contains?: Refable<JsonSchema<ExtraFields>>;
   ...
   */
  properties?: Record<string, Refable<JsonSchema<ExtraFields>> | JsonSchema<ExtraFields>>;
   ...
   */
  additionalProperties?: boolean | Refable<JsonSchema<ExtraFields>>;
